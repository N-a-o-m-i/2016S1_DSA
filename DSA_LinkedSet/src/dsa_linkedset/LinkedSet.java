...
public class LinkedSet<E> extends AbstractSet<E>
{
    ...
    //true if the set did not already contain ther element
    ...
    public boolean remove(Object o)
    {
        ...
        if(firstNode != null)
        {
            ...
            //the difference between 1.(firstNode != null) and 2.(firstNode.element == null)
            //1 is to check if the list is empty
            //2 is to check if the first element in the list is empty
            //the list with one element which is null can exist
            //so the list is not empty but the first element is null
